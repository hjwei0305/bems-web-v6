  ...
  handlerAction = (key, record) => {
    ...
    switch (key) {
      ...
      case INJECTION_REQUEST_BTN_KEY.DELETE:
        ...
        break;
      case INJECTION_REQUEST_BTN_KEY.EFFECT:
        this.effectConfirm(record);
        break;
      case INJECTION_REQUEST_BTN_KEY.CONFIRM:
        this.confirmConfirm(record);
        break;
      case INJECTION_REQUEST_BTN_KEY.CANCEL:
    ...
    this.confirmModal = Modal.confirm({
      ...
      onOk: () => {
        return new Promise(resolve => {
          ...
          dispatch({
            type: 'injectionRequestList/effective',
            payload: {
              orderId,
            },
            callback: res => {
    ...
    this.confirmModal = Modal.confirm({
      ...
      onOk: () => {
        return new Promise(resolve => {
          ...
          dispatch({
            type: 'injectionRequestList/confirm',
            payload: {
              orderId,
            },
            callback: res => {
    ...
    this.confirmModal = Modal.confirm({
      ...
      onOk: () => {
        return new Promise(resolve => {
          ...
          dispatch({
            type: 'injectionRequestList/cancel',
            payload: {
              orderId,
            },
            callback: res => {
