...
class AdjustRequestList extends Component {
  ...
  handlerAction = (key, record) => {
    ...
    switch (key) {
      ...
      case ADJUST_REQUEST_BTN_KEY.DELETE:
        ...
        break;
      case ADJUST_REQUEST_BTN_KEY.EFFECT:
        this.effectConfirm(record);
        break;
      case ADJUST_REQUEST_BTN_KEY.CONFIRM:
        this.confirmConfirm(record);
        break;
      case ADJUST_REQUEST_BTN_KEY.CANCEL:
    ...
    this.confirmModal = Modal.confirm({
      ...
      onOk: () => {
        return new Promise(resolve => {
          ...
          dispatch({
            type: 'adjustRequestList/effective',
            payload: {
              orderId,
            },
            callback: res => {
    ...
    this.confirmModal = Modal.confirm({
      ...
      onOk: () => {
        return new Promise(resolve => {
          ...
          dispatch({
            type: 'adjustRequestList/confirm',
            payload: {
              orderId,
            },
            callback: res => {
  ...
  addOrder = () => {
    const { dispatch } = this.props;
    dispatch({
      type: 'adjustRequestList/checkAdjustPrefab',
    });
  };
  ...
  handlerFilterSubmit = filterData => {
    const { dispatch, adjustRequestList } = this.props;
    const { filterData: originFilterData } = adjustRequestList;
  ...
  getFilters = () => {
    ...
    const { filterData, currentViewDate, currentViewType } = adjustRequestList;
    let hasFilter = false;
    const filters = [];
  ...
  getExtTableProps = () => {
    ...
    const props = {
      ...
      lineNumber: false,
      storageId: 'c02c0483-7f17-4c8b-9b0f-9f5b93627e1d',
...
export default AdjustRequestList;
